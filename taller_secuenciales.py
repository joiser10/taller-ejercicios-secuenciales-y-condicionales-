...
#Segundo punto
base = float(input("Digite el salario base del empleado\n"))
...
#Tercer punto
valor = float(input("Digite el valor ahorrado por la persona\n"))
tiempo = int(input("Digite el número de meses para calcular el interés\n"))
saldo_final = (tiempo*valor*0.015)+valor
...
#Quinto punto
sueldo = float(input("Digite el salario base del trabajador\n"))
...
longitud = float(input("Digite la cantidad (en cm) que tendrá el aviso\n"))
colores = int(input("Digite el número de colores que tendrá el aviso\n"))
total = (palabras*20000)+(longitud*15000)+(colores*25000)
